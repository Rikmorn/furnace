 ...
 * standard JSON Schema (+ furnace.kind in `meta`) + N target values + change
 * callbacks; output is rendered controls — the same shape a form library would
 * consume, so a future swap touches only this directory. See the M5A spec §A.
 *
