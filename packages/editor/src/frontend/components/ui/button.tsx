...
// elevation inside a raised box, which reads as a sticker rather than as depth. The
// remaining shadcn shadow strings live on those containers, where they are the point.
