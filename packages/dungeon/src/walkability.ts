 ...
 *  derived constants below, e.g. the walk-probe verify verb. Readonly: it is the single
 *  source every importer shares. */
export const AGENT: Readonly<AgentProfile> = agent;
