...
import { type CaveParams, caveDressing } from "../themes/cave.ts";
import { type BakeFile, bakeWorld, type WorldManifest } from "./bake.ts";
...
import { DEFAULT_WORLD } from "./world-spec.ts";
