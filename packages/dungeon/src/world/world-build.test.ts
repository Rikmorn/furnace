// packages/dungeon/src/world/world-build.test.ts
...
import {
  ...
  TWO_CAVES,
  TWO_HALLS,
} from "../../tests/_helpers/world-fixtures.ts";
import { forwardVector } from "../agent/fp-controller.ts";
import { HALL_PRESETS } from "../themes/hall.ts";
import type { Aabb, RegionData, Vec3 } from "./region.ts";
