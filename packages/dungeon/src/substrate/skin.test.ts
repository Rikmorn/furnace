// src/substrate/skin.test.ts
import { expect, test } from "bun:test";
import { DOOR_H_CELLS, DOOR_W_CELLS } from "../themes/grid-stamp.ts";
import { AIR, CELL, coarseSet, createCoarse, MASONRY } from "./grid.ts";
import { PANEL_PROUD, PIECE_BOX, variantHash } from "./pieces.ts";
import { type DoorSpec, faceKey, skinGrid } from "./skin.ts";
