/** 2-component vector backed by a `Float32Array` of length 2. */
...
/** 3x3 matrix backed by a `Float32Array` of length 9. Reserved — not currently produced by any function. */
