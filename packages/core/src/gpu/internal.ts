// Type-branded opaque internal state carried inside Context._internal.
// Only the gpu module's own internals construct or read these fields.

declare const __furnaceInternalBrand: unique symbol;

export type InternalState = {
  readonly [__furnaceInternalBrand]: true;
  disposed: boolean;
...
export function createInternalState(): InternalState {
  return { disposed: false } as unknown as InternalState;
}
