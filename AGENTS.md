...
**Current contents (five workspace packages):**
...
- `docs/reference/` — canonical "how the project is" docs:
  ...
  - `editor-architecture.md` — as-built M3+M4+M5A editor: daemon, project-first bundling, command registry, document session, SSE change feed + file watching, error contract, chrome, config namespacing; M5A inspector module (SchemaForm, kind→renderer registry, live-preview seam, multi-select, echo suppression)
