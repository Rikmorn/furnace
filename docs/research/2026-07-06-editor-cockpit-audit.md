...
- `docs/backlog/editor-and-tooling/editor-seams-and-preview-deferrals.md` (gone) § *Editor viewport HDR context + post-chain preview* — non-HDR context, `effects: []` deferral. *(The tracker was un-merged at genre-contracts; the section, since renamed, is `editor-viewport-is-non-hdr.md`.)*
