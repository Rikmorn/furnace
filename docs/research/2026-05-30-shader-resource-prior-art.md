...
**Fed:** the D-1 shader-resource decision — `Shader` as a first-class, non-refcounted resource, whose surface is `docs/reference/core-modules.md` §`@furnace/core/shader`. Its live residue cites this file four times: `docs/backlog/engine-architecture/include-composition-resolver.md`, `docs/backlog/engine-architecture/composition-validation-cli.md`, `docs/backlog/engine-architecture/shadersource-load-url.md` and `docs/backlog/engine-architecture/shader-refcount-decision.md`.
