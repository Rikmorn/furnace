---
summary: a scatter session seeds the chosen archetype's authored scatter block ONCE at open, so switching archetype in the form afterwards keeps the previous one's density and spacing — the props are placed with the wrong distribution and nothing says so
---
