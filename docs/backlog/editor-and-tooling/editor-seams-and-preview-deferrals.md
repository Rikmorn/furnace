...
**Absorbed at T5 (2026-08-11):** *The studio key light blows out geometry close to the
camera*, last section — a preview-fidelity deferral on the same viewport render path the
non-HDR/no-post section already covers.
