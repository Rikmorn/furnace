---
summary: the segment brush sweeps the brush SPHERE only; the box cross-section — a rectangular corridor — was the first trim off Task 13, and it carries a sweep-roll question, a kit-lattice validation rule and a per-sample rotation in the applier's innermost loop
---
