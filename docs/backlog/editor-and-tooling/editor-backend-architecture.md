...
- `engine-architecture/transform-hierarchy-helpers.md` — runtime hierarchy / world-matrix composition (the *structure*). *(Renamed from `scene-graph-helpers.md` at T2 — still deferred, still unbuilt.)*
