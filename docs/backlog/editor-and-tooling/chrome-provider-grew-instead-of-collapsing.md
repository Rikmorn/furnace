---
summary: the foundations design said the view-model layer would COLLAPSE the chrome's 11-context provider; `useFieldHostState.tsx` came out 25% larger than when the programme started — recorded as a MISS by user ruling, not as scheduled work
---
