---
summary: the tool rail presents `Dig | Fill | Paint | Smooth | Segment` as an exclusive list, but segment is a GESTURE composing with whichever effect is armed — the state is effect × gesture, and three code sites pay for presenting it as one dimension
---

# Segment reads as a fifth brush, but it is a modifier on the other four

*(Absorbed into the field-tool register at T5, 2026-08-11 — the tool family's own taxonomy question.)*
