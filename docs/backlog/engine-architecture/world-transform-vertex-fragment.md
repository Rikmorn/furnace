---
summary: the world-transform vertex prologue is copied across three shader built-ins, one of them a near-miss, so sharing it as a `shader.source` fragment needs a boundary decision rather than a mechanical move
---
