---
summary: the first frame of a bloom-bearing scene compiles roughly a dozen pipelines synchronously on the render path; pre-warming them would reintroduce the async channel the lazy-compile reshape dropped
---
