---
summary: `@furnace/core/animation` — tweens, easing curves, keyframe sequences and eventually skinning over `frame.fixedClock`, unbuilt and waiting on a demo needing motion beyond per-frame manual updates
---
