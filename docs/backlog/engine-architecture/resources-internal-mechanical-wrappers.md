---
summary: `resources/internal.ts` carries a pile of pass-through wrapper functions whose value is the package-private seam rather than logic — a deletion pass should ask each whether the seam still needs it
---
