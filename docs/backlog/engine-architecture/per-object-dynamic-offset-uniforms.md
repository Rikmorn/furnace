---
summary: one 64-byte `GPUBuffer` plus a bind-group entry per mesh is fine for handfuls and expensive at thousands; a shared pool addressed by dynamic offsets is the standard fix
---
