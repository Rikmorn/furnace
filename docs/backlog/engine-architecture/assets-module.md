---
summary: `@furnace/core/assets` — the async asset-loading pipeline (glTF, OBJ, KTX2, audio) whose caching, progress reporting, typed load errors and colour-space inference are all still open
---
