...
**Reference:** A-8 API-posture tranche (2026-05-29). Canon: `docs/reference/api-posture.md` (R8 abstraction tier; Command function-kind). Prior art: `docs/research/api-posture-prior-art.md`. Related: the *Multi-camera / multi-pass scenes* section, `post-chain-follow-ons.md` (*Post: multi-pass effects* section).
