---
summary: the eventual Rust-to-wasm replacement for the pure-TS `transform` hot loop, a specific instance of the module-wasm-backing pattern behind an unchanged function-level API
---
