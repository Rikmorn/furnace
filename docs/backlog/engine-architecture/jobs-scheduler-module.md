---
summary: `@furnace/core/jobs` — one submission surface over GPU dispatches, sync wasm calls and Worker messages; the orchestrator metaphor is right but no browser API unifies the substrates today
---
