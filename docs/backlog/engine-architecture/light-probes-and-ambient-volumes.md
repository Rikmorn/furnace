---
summary: ambient is one hemisphere term uniform across the whole scene, so nothing picks up local indirect colour; position-varying ambient needs a probe or irradiance-volume subsystem that overlaps PBR's IBL machinery
---
...
This also overlaps with the IBL machinery deferred for PBR
