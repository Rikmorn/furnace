---
summary: the indexed-vs-non-indexed draw dispatch is written twice — the scene pass and the depth-only shadow caster pass — and converges into a shared `_recordGeometryDraw` when a third draw site lands
---
