---
summary: authoring a light's colour as a Kelvin temperature is pure sugar over the existing linear-RGB `Light.color`, adding no engine state, binding or shader change
---
