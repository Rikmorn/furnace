---
summary: a fixed 16-light Scene-UBO array caps simultaneous real light sources regardless of scene size, so scattered emitters that genuinely illuminate need clustered forward+ or deferred shading, chosen by a research pass first
---
...
- Related: `pbr-material-pipeline.md`, `cascaded-and-point-shadows.md`,
  `area-and-ies-lights.md`, `render-graph.md`.
