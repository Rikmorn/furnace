---
summary: the standard pos/normal/uv vertex buffer layout is declared twice, in `material.ts` and in the shadow caster pipeline, and both copies must stay in lockstep until a third pipeline consumer earns the extraction
---
