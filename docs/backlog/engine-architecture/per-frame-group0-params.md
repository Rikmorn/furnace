---
summary: `ensurePerFrameGroup0` has grown one per-frame Scene-binding param per capability; the next one should introduce a `FrameBindings` value object instead of a seventh argument
---
