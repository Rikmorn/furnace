---
summary: the caster pipeline writes solid depth with no fragment alpha test, so cutout foliage casts its quad's silhouette and translucent casters cast fully opaque shadows
---
