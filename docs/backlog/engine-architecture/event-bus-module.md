---
summary: `@furnace/core/bus` — a cross-module pub/sub channel for events whose producers and consumers are independent, distinct from the per-module `onX` events a producer owns directly
---
