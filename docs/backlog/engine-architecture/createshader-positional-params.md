---
summary: `_createShader` takes seven positional params with three trailing booleans, so call sites read as unreadable flag runs — collapse them into an internal options object rather than adding a fourth flag
---
