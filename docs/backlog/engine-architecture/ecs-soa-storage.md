---
summary: `@furnace/core/ecs` — SoA component storage with read/write system scheduling, classified as a higher-tier module built on the core handle layer and not justified below ~1000 entities
---
...
Connects to `behaviour-runtime-contract.md` — how component types are defined and stored is the central design question alongside the storage layout itself.
