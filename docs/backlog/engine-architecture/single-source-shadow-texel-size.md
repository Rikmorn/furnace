...
`shadow-map-resolution-and-kernel-config.md`), OR a deliberate decision to
...
`shadow-map-resolution-and-kernel-config.md` (configurability is the likely trigger).
