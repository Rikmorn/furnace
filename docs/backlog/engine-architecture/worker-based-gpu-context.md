...
**Reference:** `docs/superpowers/specs/2026-05-21-core-architecture-design.md` § "Tier 2 cross-cutting patterns"; `docs/research/shallot.md` for prior art on running WebGPU in non-main-thread contexts (none specifically uses worker contexts but the substrate-offload thinking matches).
