...
- [core-internal-structure-debt](engine-architecture/core-internal-structure-debt.md) — core files whose internal shape is wrong (a 1370-line four-codec `field/artifact.ts` and siblings) — fix on the next substantial touch rather than extend
